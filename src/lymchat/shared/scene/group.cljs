(ns lymchat.shared.scene.group
  (:require [reagent.core :as r]
            ...
            [lymchat.shared.ui :refer [text view touchable-highlight scroll material-icon-button button icon image input touchable-opacity dimensions list-view react-native] :as ui]
...
(defn original-search-cp
  []
  (let [hidden-input (r/atom "")
...
(defn search-cp
  []
  (util/wrap-route original-search-cp {:navigationBar {:title "Search Groups"
                                                       :visible false}}))

(defn original-groups-cp
  []
